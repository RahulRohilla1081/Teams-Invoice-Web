...
import { AppBar, Box, Toolbar, Tooltip, IconButton, Typography, Menu, MenuIcon, Container, Avatar, Button, MenuItem, AdbIcon, Tab, Tabs, Table, TableBody, TableContainer, th, tr, Paper, TableHead, TableRow } from '@mui/material';
                        ...
                        <TableBody>
                            {InvoiceColumn.map((row, rowIndex) => (
                                <tr key={rowIndex}>
                                    ...
                                    <td key={rowIndex}>{row["Invoice Amount(inclusive of tax)"]}</td>
